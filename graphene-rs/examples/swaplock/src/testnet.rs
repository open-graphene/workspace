/// Public Swaplock testnet database RPC endpoint used by examples.
...
/// Shared Swaplock testnet sender account used by examples.
pub const SWAPLOCK_TESTNET_FROM_ACCOUNT: &str = "swaplock";

/// Shared Swaplock testnet recipient account used by examples.
pub const SWAPLOCK_TESTNET_TO_ACCOUNT: &str = "committee-account";

/// Core asset used by Swaplock testnet transfer examples.
pub const SWAPLOCK_TESTNET_TRANSFER_ASSET: &str = "1.3.0";

/// Tiny amount used by Swaplock testnet transfer examples.
