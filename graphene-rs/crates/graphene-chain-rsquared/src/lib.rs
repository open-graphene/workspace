...
mod tests {
    ...
    #[test]
    fn parses_account_ids_from_rsquared_object_ids() {
        let account: account::Id = "1.2.345".parse().expect("valid RSquared account id");
    ...
    #[test]
    fn parses_asset_ids_from_rsquared_object_ids() {
        let asset: asset::Id = "1.3.7".parse().expect("valid RSquared asset id");
    ...
    #[test]
    fn parses_committee_member_ids_from_rsquared_object_ids() {
        let committee_member: committee_member::Id =
            "1.5.9".parse().expect("valid RSquared committee member id");
    ...
    #[test]
    fn parses_witness_ids_from_rsquared_object_ids() {
        let witness: witness::Id = "1.6.11".parse().expect("valid RSquared witness id");
