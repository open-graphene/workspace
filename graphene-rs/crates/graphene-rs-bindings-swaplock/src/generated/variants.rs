...
// Chain: swaplock; Graphene static_variant bindings.

use serde::de::{Deserialize, Deserializer, Error as _};
use serde::ser::{Serialize, SerializeTuple, Serializer};

/// `graphene::protocol::fee_parameters` — 78 Graphene static_variant alternatives.
#[derive(Clone, Debug)]
...
impl<'de> Deserialize<'de> for FeeParameters {
    fn deserialize<__D: Deserializer<'de>>(deserializer: __D) -> Result<Self, __D::Error> {
        let (index, payload): (u32, serde_json::Value) = Deserialize::deserialize(deserializer)?;
        match index {
...
/// `graphene::protocol::future_extensions` — 1 Graphene static_variant alternatives.
#[derive(Clone, Debug)]
...
/// `graphene::protocol::htlc_hash` — 4 Graphene static_variant alternatives.
#[derive(Clone, Debug)]
pub enum HtlcHash {
...
/// `graphene::protocol::limit_order_auto_action` — 1 Graphene static_variant alternatives.
#[derive(Clone, Debug)]
...
/// `graphene::protocol::operation` — 78 Graphene static_variant alternatives.
#[derive(Clone, Debug)]
pub enum Operation {
...
/// `graphene::protocol::operation_result` — 6 Graphene static_variant alternatives.
#[derive(Clone, Debug)]
...
/// `graphene::protocol::predicate` — 3 Graphene static_variant alternatives.
#[derive(Clone, Debug)]
pub enum Predicate {
...
/// `graphene::protocol::restriction::argument_type` — 42 Graphene static_variant alternatives.
#[derive(Clone, Debug)]
pub enum RestrictionArgumentType {
    ...
    Int64T(GrapheneInt64),
    /// Wire index `3` — C++ `string`.
    String(String),
    /// Wire index `4` — C++ `time_point_sec`.
    TimePointSec(GrapheneTimePointSec),
...
/// `graphene::protocol::special_authority` — 2 Graphene static_variant alternatives.
#[derive(Clone, Debug)]
...
/// `graphene::chain::vesting_policy` — 3 Graphene static_variant alternatives.
#[derive(Clone, Debug)]
...
/// `graphene::protocol::vesting_policy_initializer` — 3 Graphene static_variant alternatives.
#[derive(Clone, Debug)]
...
/// `graphene::protocol::worker_initializer` — 3 Graphene static_variant alternatives.
#[derive(Clone, Debug)]
...
/// `graphene::chain::worker_type` — 3 Graphene static_variant alternatives.
#[derive(Clone, Debug)]
pub enum WorkerType {
