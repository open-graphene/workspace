...
use crate::generated::{
    Asset, AssetAssetId, ExtensionsType, FutureExtensions, GrapheneTimePointSec, Operation,
    Transaction, TransferOperation, TransferOperationFrom, TransferOperationTo,
};
