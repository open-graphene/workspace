...
// Source: legacy generated OpenRPC acta/spec.json (methods)
...
pub enum GetObjectResult {
    ...
    RoomKeyEpochObject(RoomKeyEpochObject),
    RoomObject(RoomObject),
    RoomParticipantObject(RoomParticipantObject),
...
impl OpenRpcParams for GetContentCardsParams {
    const METHOD: &'static str = "get_content_cards";
    type Response = Vec<ContentCardObject>;
...
impl OpenRpcParams for GetContentCardsByRoomParams {
    const METHOD: &'static str = "get_content_cards_by_room";
    type Response = Vec<ContentCardObject>;
...
impl OpenRpcParams for GetPermissionsParams {
    const METHOD: &'static str = "get_permissions";
    type Response = Vec<PermissionObject>;
...
impl OpenRpcParams for GetPersonalDataParams {
    const METHOD: &'static str = "get_personal_data";
    type Response = Vec<PersonalDataObject>;
...
impl OpenRpcParams for GetRoomKeyEpochsParams {
    const METHOD: &'static str = "get_room_key_epochs";
    type Response = Vec<RoomKeyEpochObject>;
...
impl OpenRpcParams for GetRoomParticipantsParams {
    const METHOD: &'static str = "get_room_participants";
    type Response = Vec<RoomParticipantObject>;
...
impl OpenRpcParams for GetRoomsByOwnerParams {
    const METHOD: &'static str = "get_rooms_by_owner";
    type Response = Vec<RoomObject>;
...
impl OpenRpcParams for GetRoomsByParticipantParams {
    const METHOD: &'static str = "get_rooms_by_participant";
    type Response = Vec<RoomParticipantObject>;
