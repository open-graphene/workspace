...
// Chain: acta; Graphene static_variant bindings.

use serde::de::{Deserialize, Deserializer, Error as _};
use serde::ser::{Serialize, SerializeTuple, Serializer};

/// `graphene::protocol::fee_parameters` — 71 Graphene static_variant alternatives.
#[derive(Clone, Debug)]
...
/// `graphene::protocol::operation` — 71 Graphene static_variant alternatives.
#[derive(Clone, Debug)]
pub enum Operation {
