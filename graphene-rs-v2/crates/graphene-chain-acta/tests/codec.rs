...
fn sign_transaction_builds_signed_envelope_from_signer_trait() {
    ...
    let signed = sign_transaction(&fixture_chain_id(), transaction.clone(), &signer)
