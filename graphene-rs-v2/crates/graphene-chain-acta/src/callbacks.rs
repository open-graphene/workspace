...
mod tests {
    ...
    fn block_applied_notice_decodes_array_payload() {
        let raw = json!(["0003a6f82437593019e927f00153bfa8e77e9912"]);
        let notice = BlockAppliedNotice::try_from(raw.clone()).unwrap();

        assert_eq!(notice.block_id, "0003a6f82437593019e927f00153bfa8e77e9912");
    ...
    fn block_applied_notice_rejects_unexpected_payload() {
        let raw = json!({ "block_id": "0003a6f82437593019e927f00153bfa8e77e9912" });
