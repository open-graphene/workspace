...
- Graphene static variants encoded as `[index, payload]`

Legacy `x-rust-type` scalar metadata is currently a warning until it is migrated to neutral `x-graphene-*` metadata.
